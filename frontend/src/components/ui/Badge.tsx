...
type BadgeVariant = 'default' | 'success' | 'warning' | 'error' | 'danger' | 'info' | 'brand'
...
const variantClasses: Record<BadgeVariant, string> = {
  ...
  error: 'bg-red-50 text-red-700 border-red-200 dark:bg-rose-950/60 dark:text-rose-300 dark:border-rose-800',
  danger: 'bg-red-50 text-red-700 border-red-200 dark:bg-rose-950/60 dark:text-rose-300 dark:border-rose-800',
